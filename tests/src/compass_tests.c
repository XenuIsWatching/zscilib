...
ZTEST(zsl_tests, test_comp_dms_to_dd)
{
	...
	zassert_true(val_is_equal(dd, 2.5, ZSL_CONSTANT(1E-6)), NULL);
	rc = zsl_comp_dms_to_dd(-2.0, 29.5, 30.0, &dd);
	zassert_true(rc == 0, NULL);
	zassert_true(val_is_equal(dd, -2.5, ZSL_CONSTANT(1E-6)), NULL);
...
ZTEST(zsl_tests, test_comp_magn_north)
{
	...
	rc = zsl_comp_magn_north(&m, &d);
	zassert_true(rc == 0, NULL);
	zassert_true(val_is_equal(d, 180.0, ZSL_CONSTANT(1E-6)), NULL);
	...
	rc = zsl_comp_magn_north(&m, &d);
	zassert_true(rc == 0, NULL);
	zassert_true(val_is_equal(d, 45.0, ZSL_CONSTANT(1E-6)), NULL);
...
ZTEST(zsl_tests, test_comp_geo_north)
{
	...
	zassert_true(rc == 0, NULL);
	zassert_true(val_is_equal(d, 10.0, ZSL_CONSTANT(1E-6)), NULL);
	...
	rc = zsl_comp_geo_north(&m, 10.0, &d);
	zassert_true(rc == 0, NULL);
	zassert_true(val_is_equal(d, 190.0, ZSL_CONSTANT(1E-6)), NULL);
	...
	rc = zsl_comp_geo_north(&m, 10.0, &d);
	zassert_true(rc == 0, NULL);
	zassert_true(val_is_equal(d, 55.0, ZSL_CONSTANT(1E-6)), NULL);
