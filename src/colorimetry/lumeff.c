...
static const struct zsl_clr_spd zsl_clr_conv_lef_cie51_scotopic_5nm = {
	...
	.comps =
	{
		{ .nm = 380, .value = ZSL_CONSTANT(5.89E-01) },
		{ .nm = 385, .value = ZSL_CONSTANT(1.108E+00) },
		{ .nm = 390, .value = ZSL_CONSTANT(2.209E+00) },
		{ .nm = 395, .value = ZSL_CONSTANT(4.53E+00) },
		{ .nm = 400, .value = ZSL_CONSTANT(9.29E+00) },
		{ .nm = 405, .value = ZSL_CONSTANT(1.852E+01) },
		{ .nm = 410, .value = ZSL_CONSTANT(3.484E+01) },
		{ .nm = 415, .value = ZSL_CONSTANT(6.04E+01) },
		{ .nm = 420, .value = ZSL_CONSTANT(9.66E+01) },
		{ .nm = 425, .value = ZSL_CONSTANT(1.436E+02) },
		{ .nm = 430, .value = ZSL_CONSTANT(1.998E+02) },
		{ .nm = 435, .value = ZSL_CONSTANT(2.625E+02) },
		{ .nm = 440, .value = ZSL_CONSTANT(3.281E+02) },
		{ .nm = 445, .value = ZSL_CONSTANT(3.931E+02) },
		{ .nm = 450, .value = ZSL_CONSTANT(4.55E+02) },
		{ .nm = 455, .value = ZSL_CONSTANT(5.13E+02) },
		{ .nm = 460, .value = ZSL_CONSTANT(5.67E+02) },
		{ .nm = 465, .value = ZSL_CONSTANT(6.2E+02) },
		{ .nm = 470, .value = ZSL_CONSTANT(6.76E+02) },
		{ .nm = 475, .value = ZSL_CONSTANT(7.34E+02) },
		{ .nm = 480, .value = ZSL_CONSTANT(7.93E+02) },
		{ .nm = 485, .value = ZSL_CONSTANT(8.51E+02) },
		{ .nm = 490, .value = ZSL_CONSTANT(9.04E+02) },
		{ .nm = 495, .value = ZSL_CONSTANT(9.49E+02) },
		{ .nm = 500, .value = ZSL_CONSTANT(9.82E+02) },
		{ .nm = 505, .value = ZSL_CONSTANT(9.98E+02) },
		{ .nm = 510, .value = ZSL_CONSTANT(9.97E+02) },
		{ .nm = 515, .value = ZSL_CONSTANT(9.75E+02) },
		{ .nm = 520, .value = ZSL_CONSTANT(9.35E+02) },
		{ .nm = 525, .value = ZSL_CONSTANT(8.8E+02) },
		{ .nm = 530, .value = ZSL_CONSTANT(8.11E+02) },
		{ .nm = 535, .value = ZSL_CONSTANT(7.33E+02) },
		{ .nm = 540, .value = ZSL_CONSTANT(6.5E+02) },
		{ .nm = 545, .value = ZSL_CONSTANT(5.64E+02) },
		{ .nm = 550, .value = ZSL_CONSTANT(4.81E+02) },
		{ .nm = 555, .value = ZSL_CONSTANT(4.02E+02) },
		{ .nm = 560, .value = ZSL_CONSTANT(3.288E+02) },
		{ .nm = 565, .value = ZSL_CONSTANT(2.639E+02) },
		{ .nm = 570, .value = ZSL_CONSTANT(2.076E+02) },
		{ .nm = 575, .value = ZSL_CONSTANT(1.602E+02) },
		{ .nm = 580, .value = ZSL_CONSTANT(1.212E+02) },
		{ .nm = 585, .value = ZSL_CONSTANT(8.99E+01) },
		{ .nm = 590, .value = ZSL_CONSTANT(6.55E+01) },
		{ .nm = 595, .value = ZSL_CONSTANT(4.69E+01) },
		{ .nm = 600, .value = ZSL_CONSTANT(3.315E+01) },
		{ .nm = 605, .value = ZSL_CONSTANT(2.312E+01) },
		{ .nm = 610, .value = ZSL_CONSTANT(1.593E+01) },
		{ .nm = 615, .value = ZSL_CONSTANT(1.088E+01) },
		{ .nm = 620, .value = ZSL_CONSTANT(7.37E+00) },
		{ .nm = 625, .value = ZSL_CONSTANT(4.97E+00) },
		{ .nm = 630, .value = ZSL_CONSTANT(3.335E+00) },
		{ .nm = 635, .value = ZSL_CONSTANT(2.235E+00) },
		{ .nm = 640, .value = ZSL_CONSTANT(1.497E+00) },
		{ .nm = 645, .value = ZSL_CONSTANT(1.005E+00) },
		{ .nm = 650, .value = ZSL_CONSTANT(6.77E-01) },
		{ .nm = 655, .value = ZSL_CONSTANT(4.59E-01) },
		{ .nm = 660, .value = ZSL_CONSTANT(3.129E-01) },
		{ .nm = 665, .value = ZSL_CONSTANT(2.146E-01) },
		{ .nm = 670, .value = ZSL_CONSTANT(1.48E-01) },
		{ .nm = 675, .value = ZSL_CONSTANT(1.026E-01) },
		{ .nm = 680, .value = ZSL_CONSTANT(7.15E-02) },
		{ .nm = 685, .value = ZSL_CONSTANT(5.01E-02) },
		{ .nm = 690, .value = ZSL_CONSTANT(3.533E-02) },
		{ .nm = 695, .value = ZSL_CONSTANT(2.501E-02) },
		{ .nm = 700, .value = ZSL_CONSTANT(1.78E-02) },
		{ .nm = 705, .value = ZSL_CONSTANT(1.273E-02) },
		{ .nm = 710, .value = ZSL_CONSTANT(9.14E-03) },
		{ .nm = 715, .value = ZSL_CONSTANT(6.6E-03) },
		{ .nm = 720, .value = ZSL_CONSTANT(4.78E-03) },
		{ .nm = 725, .value = ZSL_CONSTANT(3.482E-03) },
		{ .nm = 730, .value = ZSL_CONSTANT(2.546E-03) },
		{ .nm = 735, .value = ZSL_CONSTANT(1.87E-03) },
		{ .nm = 740, .value = ZSL_CONSTANT(1.379E-03) },
		{ .nm = 745, .value = ZSL_CONSTANT(1.022E-03) },
		{ .nm = 750, .value = ZSL_CONSTANT(7.6E-04) },
		{ .nm = 755, .value = ZSL_CONSTANT(5.67E-04) },
		{ .nm = 760, .value = ZSL_CONSTANT(4.25E-04) },
		{ .nm = 765, .value = ZSL_CONSTANT(3.196E-04) },
		{ .nm = 770, .value = ZSL_CONSTANT(2.413E-04) },
		{ .nm = 775, .value = ZSL_CONSTANT(1.829E-04) },
		{ .nm = 780, .value = ZSL_CONSTANT(1.39E-04) }
	}
};
